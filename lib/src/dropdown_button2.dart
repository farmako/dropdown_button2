                    ...
                    child: Padding(
                      ...
                      child: ScrollConfiguration(
                        ...
                        child: PrimaryScrollController(
                          ...
                          child:
                              _isIOS ? _materialScrollBar : _cupertinoScrollBar,
                        ),
                      ),
                    ),
                  ),
...
class DropdownButton2<T> extends StatefulWidget {
  ...
  DropdownButton2({
    super.key,
    required this.items,
    required this.isFocusElseWhere,
  ...
  /// Flag variable to check whether the drop down menu has the current focus or is it somewhere else. Based on this the delay in the opening of the menu is decided.
  final bool isFocusElseWhere;
...
class DropdownButton2State<T> extends State<DropdownButton2<T>>
  ...
  Future<void> _handleTap() async {
    if (widget.isFocusElseWhere) {
      FocusScope.of(context).requestFocus(_focusNode);
      const focusTransitionDuration = Duration(milliseconds: 700);
      await Future.delayed(focusTransitionDuration, () {});
    }
...
class DropdownButtonFormField2<T> extends FormField<T> {
  ...
  DropdownButtonFormField2({
    ...
    required bool isFocusElseWhere,
                ...
                builder: (BuildContext context) {
                  return DropdownButtonHideUnderline(
                    child: DropdownButton2<T>._formField(
                      ...
                      isFocusElseWhere: isFocusElseWhere,
                      items: items,
